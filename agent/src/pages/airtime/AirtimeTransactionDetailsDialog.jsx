// src/pages/airtime/AirtimeTransactionDetailsDialog.jsx
import {
  Dialog,
  DialogTitle,
  DialogContent,
...
const AirtimeTransactionDetailsDialog = ({ open, onClose, transaction }) => {
        ...
        <Stack spacing={2}>
          <Grid container spacing={2}>
            ...
            {transaction.info?.plan_name && (
              <Grid item xs={12} sm={6}>
                <DetailRow label="Plan" value={transaction.info.plan_name} />
              </Grid>
            )}
...
export default AirtimeTransactionDetailsDialog;